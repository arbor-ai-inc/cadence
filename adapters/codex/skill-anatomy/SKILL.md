...
<!-- GENERATED by scripts/gen_adapters.py from skills/skill-anatomy/SKILL.md.
Do not edit: run the generator instead. The canonical workflow is
reference/skill-anatomy.md; this file only routes an agent to it. -->
Follow the canonical procedure in `.cadence/reference/skill-anatomy.md` exactly.
