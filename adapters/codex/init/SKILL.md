...
<!-- GENERATED by scripts/gen_adapters.py from skills/init/SKILL.md.
Do not edit: run the generator instead. The canonical workflow is
reference/init.md; this file only routes an agent to it. -->
...
Confirm it loaded with `python3 .cadence/tools/cadence_config.py`, and show the author the effective config.
