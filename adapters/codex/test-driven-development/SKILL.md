...
<!-- GENERATED by scripts/gen_adapters.py from skills/test-driven-development/SKILL.md.
Do not edit: run the generator instead. The canonical workflow is
reference/test-driven-development.md; this file only routes an agent to it. -->
Follow the canonical procedure in `.cadence/reference/test-driven-development.md` exactly.
